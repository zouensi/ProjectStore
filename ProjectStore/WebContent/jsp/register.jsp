		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" style="margin-top: 5px;" method="post"
					...
					<input type="hidden" name="method" value="registerInfo">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="userYum">
						...
						<div style="text-align:left ;color: red">${requestScope.msg}</div>
					</div>
					<div class="form-group">
